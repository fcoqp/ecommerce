...
<head>
  ...
  <title>Adim - Luz Aromatica</title>
...
<section class="container mt-5">
  <div class="row g-3">
    <div class="col-12 col-md-5 m-5">
      <a href="productos/mostrar_productos.php" class="btn btn-dark btn-lg w-100 d-flex align-items-center justify-content-center square-btn">
    ...
    <div class="col-12 col-md-5 m-5">
      <a href="categorias.php" class="btn btn-dark btn-lg w-100 d-flex align-items-center justify-content-center square-btn">
    ...
    <div class="col-12 col-md-5 m-5">
      <a href="pedidos.php" class="btn btn-dark btn-lg w-100 d-flex align-items-center justify-content-center square-btn">
    ...
    <div class="col-12 col-md-5 m-5">
      <a href="informes.php" class="btn btn-dark btn-lg w-100 d-flex align-items-center justify-content-center square-btn">
    ...
    <div class="col-12 col-md-5 m-5">
      <a href="usuarios/mostrar_usuarios.php" class="btn btn-dark btn-lg w-100 d-flex align-items-center justify-content-center square-btn">
    ...
    <div class="col-12 col-md-5 m-5">
      <a href="../perfil.php" class="btn btn-dark btn-lg w-100 d-flex align-items-center justify-content-center square-btn">
